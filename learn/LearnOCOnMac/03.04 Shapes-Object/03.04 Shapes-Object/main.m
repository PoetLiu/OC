...
- (void) draw
{
	NSLog(@"drawing a Egg at (%d %d %d %d) in %@", bounds.x, bounds.y,bounds.width,
		  bounds.height, colorName(fillColor));
} // draw
@end
...
- (void) draw
{
	NSLog(@"drawing a Rectangle at (%d %d %d %d) in %@", bounds.x, bounds.y,bounds.width,
		  bounds.height, colorName(fillColor));
} // draw
@end
...
- (void) draw
{
	NSLog(@"drawing a Triangle at (%d %d %d %d) in %@", bounds.x, bounds.y,bounds.width,
		  bounds.height, colorName(fillColor));
} // draw
@end
